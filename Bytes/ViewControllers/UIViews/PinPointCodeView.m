...
-(void) setBytesTo: (NSInteger)bytes {
    ...
    [[self randomCode] setTitle:[NSString stringWithFormat:@"%ld", (long)[codeHelper bytes]] forState:UIControlStateNormal];
    
    if ([codeHelper code] > 0) {
        [[self codeField] setText:[NSString stringWithFormat:@"%ld", (long)[codeHelper code]]];
